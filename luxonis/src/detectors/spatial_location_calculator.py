    ...
    with dai.Device(pipeline) as device:
        ...
        while True:
            ...
            for depthData in spatialData:
                ...
                cv2.putText(depthFrameColor, f"X: {int(depthData.spatialCoordinates.x)} mm", (
                    xmin + 10, ymin + 20), fontType, 0.5, color)
                cv2.putText(depthFrameColor, f"Y: {int(depthData.spatialCoordinates.y)} mm", (
